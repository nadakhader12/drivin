    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsefacts" class="collapse" aria-labelledby="headingfacts"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">

                        <a class="collapse-item" href="{{ route('admin.facts.index') }}">All facts </a>
                        <a class="collapse-item" href="{{ route('admin.facts.create') }}">Add new </a>
                        <a class="collapse-item" href="{{ route('admin.facts.trash') }}">tashed </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsecourses" class="collapse" aria-labelledby="headingcourses"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('admin.courses.trash') }}">trashed </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseappointment" class="collapse" aria-labelledby="headingappointment"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('admin.appointments.index') }}">All appointment</a>
                        <a class="collapse-item" href="{{ route('admin.appointments.create') }}">Add new</a>
                        <a class="collapse-item" href="{{ route('admin.appointments.trash') }}">trashed </a>
